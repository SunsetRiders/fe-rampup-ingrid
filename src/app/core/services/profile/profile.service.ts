  ...
  private info: ProfileInfo[] = [
    {
      ...
      type: ProfileInfoType.Default,
      highlight: true
    },
    {
      name: 'Birthday',
      content: '1996-12-21T02:00:00.000Z',
      type: ProfileInfoType.Age,
      highlight: false
    },
    {
      name: 'Phone',
      content: '+1 256 243 84 56',
      type: ProfileInfoType.Default,
      highlight: false
    },
    {
